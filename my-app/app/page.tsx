...
export default function AboutUs() {
  ...
  <h2 className="text-2xl font-semibold mb-4 text-purple-600 dark:text-purple-400">Our Mission</h2>
  <div className="flex flex-col md:flex-row items-center gap-12">
    ...
    <div className="md:w-1/2 ml-8"> {/* Add ml-8 here to move the image right */}
      <Image
        src="/newguy.png"
      ...
      />
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-purple-600 dark:text-purple-400">Understanding Addiction</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4  text-purple-600 dark:text-purple-400">Support and Resources</h2>
        ...
        <section className="mb-12">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-purple-600 dark:text-purple-400">Who are we?</h2>
